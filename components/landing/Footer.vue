<template>
  <footer class="bottom-0 w-full bg-muted text-muted-foreground">
    ...
    <div class="flex flex-col justify-between gap-2 p-4 md:flex-row md:px-6">
      <p class="order-2 p-2 text-sm md:order-1">
        © 2024 Cytro. All rights reserved.
      </p>
      <div class="order-1 flex items-center gap-x-2 md:order-2">
        <NuxtLink class="p-2" to="https://x.com/Cytro" target="_blank" external>
          <svg
            role="img"
            viewBox="0 0 24 24"
        ...
        <NuxtLink
          class="p-2"
          to="https://discordapp.com/users/722979609427312720"
          target="_blank"
          external
        >
          <svg
